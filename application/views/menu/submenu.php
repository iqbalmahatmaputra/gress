			...
			<table class="table table-hover text-center">
				...
				<tbody>
					...
					<tr>
						...
						<td><?= $sm['is_active']; ?></td>
						<td>
							<a href="<?php echo site_url('Menu/edit_sub_menu/'.$sm['id']); ?>" class="badge badge-pill badge-success">Ubah</a>
							<a href="<?php echo site_url('Menu/hapus_sub_menu/'.$sm['id']); ?>" class="badge badge-pill badge-danger">Hapus</a>
						</td>
					</tr>
					<?php $i++; ?>
					<?php endforeach; ?>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel"
  ...
  <input checked class="custom-control-input" type="checkbox" value="1" id="is_active" name="is_active">
