			...
			<table class="table table-hover text-center">
				...
				<tbody>
					...
					<tr>
						...
						<td><?= $m['menu']; ?></td>
						<td>
							<a href="<?php echo site_url('Menu/edit_menu/'.$m['id']); ?>" class="badge badge-pill badge-success">Ubah</a>
							<a href="<?php echo site_url('Menu/hapus_menu/'.$m['id']); ?>" class="badge badge-pill badge-danger">Hapus</a>
						</td>
					</tr>
					<?php $i++; ?>
					<?php endforeach; ?>
