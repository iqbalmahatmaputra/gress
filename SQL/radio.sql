...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2020 at 03:59 AM
...
--
-- Table structure for table `jenis_content`
--

CREATE TABLE `jenis_content` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `jenis_content`
--
ALTER TABLE `jenis_content`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `jenis_content`
--
ALTER TABLE `jenis_content`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
